...
class installer_Class {
    ...
    async install_Async(pkgPath        , installType              ,
            depPkgName              = null)                {
    ...
    async #installAsync_Git(pkgPath        , abInfo        , depPkgName        , 
                depPkgPath        )                   {
    ...
    #installAsync_Git_NPMInstallDev(depPkgPath        )                {
    ...
    #installAsync_Link(pkgPath        , abInfo        , depPkgName        , 
                depPkgPath        )                   {
        return new Promise         ((resolve, reject) => {
            if (fs.existsSync(depPkgPath))
                abFS.rmdirRecursiveSync(depPkgPath);
    ...
    async #installAsync_Link_NoCopy(pkgPath        , abInfo        , 
                depPkgName        , depPkgPath        )                   {
        return new Promise((resolve, reject) => {
            if (fs.existsSync(depPkgPath))
                abFS.rmdirRecursiveSync(depPkgPath);
    ...
    async #validateLinkedBranch_Async(depPkgName        , depPkgPath        , 
                branch        )                   {
